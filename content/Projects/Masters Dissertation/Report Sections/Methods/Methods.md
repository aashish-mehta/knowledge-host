...
3. [[NeoVAD Mesh Convergence Study]]
4. [[NeoVAD Sensitivity Analysis]]
5. [[NeoVAD Blade Profile Definition]]
6. [[Automatic geometry creation, meshing and simulation of the NeoVAD]]
7. [[Modelling the NeoVAD using a GRNN]]
8. [[Finding optimal NeoVAD geometries using a Genetic Algorithm]]
